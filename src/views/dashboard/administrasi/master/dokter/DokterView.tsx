...
import { BadgeInfo, Download, Info, XIcon } from 'lucide-react'
...
export default function DokterView() {
   ...
   const handleExportExcel = () => {
      const exportData = formatTableDataForExport(dataDokter, (item, index) => ({
         'No': index + 1,
         'Nama Dokter': item.nama,
         'Spesialisasi': item.spesialisasi,
         'No Telp': item.noTelp,
      }));

      exportToExcel(exportData, 'Data_Dokter', 'Dokter');
   }
